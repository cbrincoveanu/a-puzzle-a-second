...
const TRANSITION_ANIMATION_DURATION = 600;
...
const MASTER_PIECES = [
    ...
    { name: 'L5', shape: [[1,0],[1,0],[1,0],[1,1]], color: 'chartreuse', cellCount: 5 },
    { name: 'F5', shape: [[1,0],[1,0],[1,1],[1,0]], color: 'sandybrown', cellCount: 5 },
    { name: 'Z5', shape: [[0,0,1],[1,1,1],[1,0,0]], color: 'orange', cellCount: 5 },
    { name: 'S5', shape: [[1,0],[1,0],[1,1],[0,1]], color: 'royalblue', cellCount: 5 },
